<?php
	...
	define('SECURITY_PHRASE', 'whocares');
	define('PASSWORD', '');
	define('ADMIN', FALSE);
	...
	define('TEXT_GALLERY_NAME', 'CMS904 Monitoring System');
	define('TEXT_BANNER', '');
	...
	define('TEXT_NO_IMAGES', 'click to view');
	...
	function sfpg_javascript()
	{
		...
		function showMenu()
		{
			...
			echo "menu += '<span onmouseover=\"this.className=\'sfpg_button_hover\';\" onmouseout=\"this.className=\'sfpg_button\';\" class=\"sfpg_button\" onclick=\"window.location=\'http://home.web.cern.ch/\'\">CERN</span>';
